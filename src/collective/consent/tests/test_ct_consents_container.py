# -*- coding: utf-8 -*-
from collective.consent.content.consents_container import (
    IConsentsContainer,  # NOQA E501
)
...
class ConsentsContainerIntegrationTest(unittest.TestCase):
    ...
    def test_ct_consents_container_factory(self):
        ...
        self.assertTrue(
            ...
            "IConsentsContainer not provided by {0}!".format(obj),
        )
    ...
    def test_ct_consents_container_adding(self):
        ...
        self.assertTrue(
            IConsentsContainer.providedBy(obj),
            "IConsentsContainer not provided by {0}!".format(obj.id),
        )
